...
const EditButton = ({
  ...
  return (
    <>
      ...
      {showModal && (
        <div
          className="fixed z-10 bg-black/25 inset-0 flex items-center justify-center"
          onClick={(e) => {
        ...
        >
          <div className="absolute bg-white p-4 rounded-md shadow max-w-sm">
            <header className="flex justify-between items-center gap-16">
              <h2 className="text-3xl font-extrabold">Edit Project</h2>
              <button
                className="bg-black px-3 py-2 rounded-md w-fit text-white"
            ...
            >
              ...
              <button
                className="mx-auto border bg-black px-3 py-2 rounded-md w-fit text-white"
                type="submit"
              >
                Edit
              </button>
